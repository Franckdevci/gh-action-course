...
class RelevesApiExceptionHandler {
    ...
    @ExceptionHandler(DonneeReleveInvalideException.class)
    ProblemDetail traiterDomaineInvalide(DonneeReleveInvalideException e) {
        ProblemDetail pd = ProblemDetail.forStatusAndDetail(
    ...
    @ExceptionHandler(ParcelleIntrouvableException.class)
    ProblemDetail traiterIntrouvable(ParcelleIntrouvableException e) {
        ProblemDetail pd = ProblemDetail.forStatusAndDetail(
    ...
    @ExceptionHandler(ReleveDoublonException.class)
    ProblemDetail traiterDoublon(ReleveDoublonException e) {
        ProblemDetail pd = ProblemDetail.forStatusAndDetail(
